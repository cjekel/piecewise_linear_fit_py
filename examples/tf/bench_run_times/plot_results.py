...
plt.errorbar(n, amd_fx_run_times_means[2], yerr=k*amd_fx_run_times_stds[2], capsize=2.0, label='TF CPU')
...
plt.errorbar(n[1:], amd_fx_run_times_means[2, 1:] - amd_fx_run_times_means[0, 1:], yerr=(k*amd_fx_run_times_stds[2, 1:]), capsize=2.0, label='TF CPU')
...
plt.errorbar(n[1:], amd_fx_run_times_means[2, 1:]/amd_fx_run_times_means[0, 1:], yerr=(k*amd_fx_run_times_stds[2, 1:])/amd_fx_run_times_means[0, 1:], capsize=2.0, label='TF CPU')
plt.xlabel('Number of data points')
...
plt.errorbar(n[1:], amd_fx_run_times_means[2, 1:]/amd_fx_run_times_means[1, 1:], yerr=(k*amd_fx_run_times_stds[2, 1:])/amd_fx_run_times_means[1, 1:], capsize=2.0, label='TF CPU')
plt.xlabel('Number of data points')

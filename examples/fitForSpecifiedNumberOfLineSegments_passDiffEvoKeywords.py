...
#   passing custom keywords directly to the scipy differntial evolution algo
#   see https://docs.scipy.org/doc/scipy-0.18.1/reference/generated/scipy.optimize.differential_evolution.html#scipy.optimize.differential_evolution
...
#   My differential evolutions keywords are tuned to be very agressive
#   it's probably overkill for your application
#   so you can pass your custom keywords here
#   for example I'll pass the only keyword that I want differntial evolution
#   to print the iterations with disp=True
#   if any keyword is passed, all of my agressively tuned differential evolution
#   keywords reset to the default
res = myPWLF.fit(4, disp=True)
